...
<Callout variant="info" title="Why transparent feedback">
  - Enables direct discussion and improvements  
  - Ensures employees and managers can view each other’s feedback  
  - Encourages more thoughtful, constructive comments  
</Callout>

<Callout variant="warning" title="Risks of anonymity">
  - Signals that speaking openly is unsafe (“kill the messenger”)  
  - Leads to witch hunts to identify authors  
  - Can invite venting instead of constructive feedback  
</Callout>

<Callout variant="note" title="Learn more">
  See <a href="https://www.start-pulse.com/en/resources/blog/employee-surveys-must-be-anonymous-right">this blog article</a> for deeper discussion.
</Callout>

<Callout variant="note" title="GIF to capture">
  None needed; rationale text.
</Callout>
