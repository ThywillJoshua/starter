...
<Steps>
  <Step title="Open details">
    Click a question or its score bar to open the detailed view.
  </Step>
  <Step title="Toggle distribution">
    Click **Show distribution** below the score bar. Click **Show Categories** to return to the category view.
  </Step>
</Steps>
...
<Callout variant="note" title="GIF to capture">
  Clip: open question → Show distribution → Show categories.
</Callout>
